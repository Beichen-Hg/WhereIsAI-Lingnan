...
runtime dependency specification. The Hugging Face checkpoint should be placed
under the following project-relative directory:

\begin{verbatim}
artifacts/final_refit/audio_delivery_pairwise_all_labeled_clean_no_quality_v1/
\end{verbatim}

With organizer-provided Phase 1 assets and the corresponding final feature
files available under \texttt{artifacts/}, install dependencies and run:
